...
class SolarLFO(EuroPiScript):
    ...
    def read_ain(self):
        ...
        max_voltage = self.voltage_scale  # Adjust for scaling (10V or 5V)
        normalized_ain = ain_value / max_voltage  # Normalize to 0.0 - 1.0
        return normalized_ain * self.voltage_scale  # Scale back to system voltage
    ...
    def update_ain_average(self):
        ...
        if time.ticks_diff(now, self.last_ain_update) >= 1000:
            if self.ain_samples:
